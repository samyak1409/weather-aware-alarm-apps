...
| **Nivaat**    | N1–N3         | home N12–N16 · history N4–N9, N4a, N4b, N10, N11 | N17–N23          |
...
| **N4a** missed | `Missed · {windgust}` → `Missed · wind 3 (≤4) · gusts 12 (≤15) km/h` (or bare `Missed`) | `Society Court · 18 Jul · 06:00 · last checked 06:00` |
| **N4b** unknown | `Couldn't confirm · {windgust}` → `Couldn't confirm · wind 3 (≤4) · gusts 12 (≤15) km/h` (or bare) | `Society Court · 18 Jul · 06:00 · last checked 06:00` |
...
- **What it gates:** today only Nivaat's `1m` *Keep checking* segment (N17). Arunoday has nothing behind it yet and still shows the toast — the way in should be the same in both apps.
